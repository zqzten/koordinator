...
func makeNodeForBindingTest(name string) *v1.Node {
	return &v1.Node{
		ObjectMeta: metav1.ObjectMeta{
			Name: name,
...
func makePVForBindingTest(name string, className string) *v1.PersistentVolume {
...
func makePVForBindingTestC(name string, boundPVName string, storageClassName string) *v1.PersistentVolumeClaim {
...
func makePodForBindingTest(name string, pvcNames []string) *v1.Pod {
	p := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: v1.NamespaceDefault,
...
func TestVolumeBinding(t *testing.T) {
	table := []struct {
		...
		},
		{
			...
			pvcs: []*v1.PersistentVolumeClaim{
				makePVForBindingTestC("pvc-a", "pv-a", waitSC.Name),
			},
			pvs: []*v1.PersistentVolume{
				makePVForBindingTest("pv-a", waitSC.Name),
			},
			wantStateAfterPreFilter: &stateData{
		...
		},
		{
			...
			pvcs: []*v1.PersistentVolumeClaim{
				makePVForBindingTestC("pvc-a", "", immediateSC.Name),
			},
		...
		},
		{
			...
			pvcs: []*v1.PersistentVolumeClaim{
				makePVForBindingTestC("pvc-a", "", waitSC.Name),
			},
			wantStateAfterPreFilter: &stateData{
				boundClaims: []*v1.PersistentVolumeClaim{},
				claimsToBind: []*v1.PersistentVolumeClaim{
		...
		},
		{
			...
			pod:  makePodForBindingTest("pod-a", []string{"pvc-a", "pvc-b"}),
			nodes: []*v1.Node{
				mergeNodeLabels(makeNodeForBindingTest("node-a"), map[string]string{
					"foo": "barbar",
				}),
			},
			pvcs: []*v1.PersistentVolumeClaim{
				makePVForBindingTestC("pvc-a", "pv-a", waitSC.Name),
				makePVForBindingTestC("pvc-b", "", waitSC.Name),
			},
			pvs: []*v1.PersistentVolume{
				setPVNodeAffinity(makePVForBindingTest("pv-a", waitSC.Name), map[string][]string{
					"foo": {"bar"},
				}),
			},
			wantStateAfterPreFilter: &stateData{
		...
		},
		{
			...
			nodes: []*v1.Node{
				makeNodeForBindingTest("node-a"),
				makeNodeForBindingTest("node-b"),
				makeNodeForBindingTest("node-c"),
			},
			pvcs: []*v1.PersistentVolumeClaim{
				setPVCRequestStorage(makePVForBindingTestC("pvc-a", "", waitSC.Name), resource.MustParse("50Gi")),
			},
			pvs: []*v1.PersistentVolume{
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-0", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-1", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-0", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-1", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
			},
		...
		},
		{
			...
			pod:  makePodForBindingTest("pod-a", []string{"pvc-0", "pvc-1"}),
			nodes: []*v1.Node{
				makeNodeForBindingTest("node-a"),
				makeNodeForBindingTest("node-b"),
				makeNodeForBindingTest("node-c"),
			...
			pvcs: []*v1.PersistentVolumeClaim{
				setPVCRequestStorage(makePVForBindingTestC("pvc-0", "", waitSC.Name), resource.MustParse("50Gi")),
				setPVCRequestStorage(makePVForBindingTestC("pvc-1", "", waitHDDSC.Name), resource.MustParse("100Gi")),
			},
			pvs: []*v1.PersistentVolume{
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-0", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-1", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-2", waitHDDSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-3", waitHDDSC.Name), resource.MustParse("200Gi")), map[string][]string{v1.LabelHostname: {"node-a"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-0", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-1", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-2", waitHDDSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-3", waitHDDSC.Name), resource.MustParse("100Gi")), map[string][]string{v1.LabelHostname: {"node-b"}}),
			},
			feature:             features.VolumeCapacityPriority,
			wantPreFilterStatus: nil,
			wantStateAfterPreFilter: &stateData{
		...
		},
		{
			...
			pod:  makePodForBindingTest("pod-a", []string{"pvc-a"}),
			nodes: []*v1.Node{
				mergeNodeLabels(makeNodeForBindingTest("zone-a-node-a"), map[string]string{
					"topology.kubernetes.io/region": "region-a",
					"topology.kubernetes.io/zone":   "zone-a",
				}),
				mergeNodeLabels(makeNodeForBindingTest("zone-a-node-b"), map[string]string{
					"topology.kubernetes.io/region": "region-a",
					"topology.kubernetes.io/zone":   "zone-a",
				}),
				mergeNodeLabels(makeNodeForBindingTest("zone-b-node-a"), map[string]string{
					"topology.kubernetes.io/region": "region-b",
					"topology.kubernetes.io/zone":   "zone-b",
				}),
				mergeNodeLabels(makeNodeForBindingTest("zone-b-node-b"), map[string]string{
					"topology.kubernetes.io/region": "region-b",
					"topology.kubernetes.io/zone":   "zone-b",
				}),
				mergeNodeLabels(makeNodeForBindingTest("zone-c-node-a"), map[string]string{
					"topology.kubernetes.io/region": "region-c",
					"topology.kubernetes.io/zone":   "zone-c",
				}),
				mergeNodeLabels(makeNodeForBindingTest("zone-c-node-b"), map[string]string{
					"topology.kubernetes.io/region": "region-c",
					"topology.kubernetes.io/zone":   "zone-c",
				}),
			},
			...
			pvs: []*v1.PersistentVolume{
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-0", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{
					"topology.kubernetes.io/region": {"region-a"},
					"topology.kubernetes.io/zone":   {"zone-a"},
				}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-a-1", waitSC.Name), resource.MustParse("200Gi")), map[string][]string{
					"topology.kubernetes.io/region": {"region-a"},
					"topology.kubernetes.io/zone":   {"zone-a"},
				}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-0", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{
					"topology.kubernetes.io/region": {"region-b"},
					"topology.kubernetes.io/zone":   {"zone-b"},
				}),
				setPVNodeAffinity(setPVCapacity(makePVForBindingTest("pv-b-1", waitSC.Name), resource.MustParse("100Gi")), map[string][]string{
					"topology.kubernetes.io/region": {"region-b"},
					"topology.kubernetes.io/zone":   {"zone-b"},
				}),
			},
