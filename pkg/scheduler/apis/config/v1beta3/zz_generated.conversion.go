...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ASIQuotaAdaptorArgs)(nil), (*config.ASIQuotaAdaptorArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_ASIQuotaAdaptorArgs_To_config_ASIQuotaAdaptorArgs(a.(*ASIQuotaAdaptorArgs), b.(*config.ASIQuotaAdaptorArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ASIQuotaAdaptorArgs)(nil), (*ASIQuotaAdaptorArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ASIQuotaAdaptorArgs_To_v1beta3_ASIQuotaAdaptorArgs(a.(*config.ASIQuotaAdaptorArgs), b.(*ASIQuotaAdaptorArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CachedPodArgs)(nil), (*config.CachedPodArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_CachedPodArgs_To_config_CachedPodArgs(a.(*CachedPodArgs), b.(*config.CachedPodArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CachedPodArgs)(nil), (*CachedPodArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CachedPodArgs_To_v1beta3_CachedPodArgs(a.(*config.CachedPodArgs), b.(*CachedPodArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*LimitAwareArgs)(nil), (*config.LimitAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_LimitAwareArgs_To_config_LimitAwareArgs(a.(*LimitAwareArgs), b.(*config.LimitAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LimitAwareArgs)(nil), (*LimitAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LimitAwareArgs_To_v1beta3_LimitAwareArgs(a.(*config.LimitAwareArgs), b.(*LimitAwareArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*PriorityRangeConfig)(nil), (*config.PriorityRangeConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_PriorityRangeConfig_To_config_PriorityRangeConfig(a.(*PriorityRangeConfig), b.(*config.PriorityRangeConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PriorityRangeConfig)(nil), (*PriorityRangeConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PriorityRangeConfig_To_v1beta3_PriorityRangeConfig(a.(*config.PriorityRangeConfig), b.(*PriorityRangeConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*UnifiedPodConstraintArgs)(nil), (*config.UnifiedPodConstraintArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_UnifiedPodConstraintArgs_To_config_UnifiedPodConstraintArgs(a.(*UnifiedPodConstraintArgs), b.(*config.UnifiedPodConstraintArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.UnifiedPodConstraintArgs)(nil), (*UnifiedPodConstraintArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_UnifiedPodConstraintArgs_To_v1beta3_UnifiedPodConstraintArgs(a.(*config.UnifiedPodConstraintArgs), b.(*UnifiedPodConstraintArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_ASIQuotaAdaptorArgs_To_config_ASIQuotaAdaptorArgs(in *ASIQuotaAdaptorArgs, out *config.ASIQuotaAdaptorArgs, s conversion.Scope) error {
	out.PriorityRangeConfig = *(*map[string]*config.PriorityRangeConfig)(unsafe.Pointer(&in.PriorityRangeConfig))
	return nil
}

// Convert_v1beta3_ASIQuotaAdaptorArgs_To_config_ASIQuotaAdaptorArgs is an autogenerated conversion function.
func Convert_v1beta3_ASIQuotaAdaptorArgs_To_config_ASIQuotaAdaptorArgs(in *ASIQuotaAdaptorArgs, out *config.ASIQuotaAdaptorArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_ASIQuotaAdaptorArgs_To_config_ASIQuotaAdaptorArgs(in, out, s)
}

func autoConvert_config_ASIQuotaAdaptorArgs_To_v1beta3_ASIQuotaAdaptorArgs(in *config.ASIQuotaAdaptorArgs, out *ASIQuotaAdaptorArgs, s conversion.Scope) error {
	out.PriorityRangeConfig = *(*map[string]*PriorityRangeConfig)(unsafe.Pointer(&in.PriorityRangeConfig))
	return nil
}

// Convert_config_ASIQuotaAdaptorArgs_To_v1beta3_ASIQuotaAdaptorArgs is an autogenerated conversion function.
func Convert_config_ASIQuotaAdaptorArgs_To_v1beta3_ASIQuotaAdaptorArgs(in *config.ASIQuotaAdaptorArgs, out *ASIQuotaAdaptorArgs, s conversion.Scope) error {
	return autoConvert_config_ASIQuotaAdaptorArgs_To_v1beta3_ASIQuotaAdaptorArgs(in, out, s)
}

func autoConvert_v1beta3_CachedPodArgs_To_config_CachedPodArgs(in *CachedPodArgs, out *config.CachedPodArgs, s conversion.Scope) error {
...
// Convert_v1beta3_CachedPodArgs_To_config_CachedPodArgs is an autogenerated conversion function.
func Convert_v1beta3_CachedPodArgs_To_config_CachedPodArgs(in *CachedPodArgs, out *config.CachedPodArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_CachedPodArgs_To_config_CachedPodArgs(in, out, s)
}

func autoConvert_config_CachedPodArgs_To_v1beta3_CachedPodArgs(in *config.CachedPodArgs, out *CachedPodArgs, s conversion.Scope) error {
	out.Network = in.Network
	out.Address = in.Address
	out.ServerCert = *(*[]byte)(unsafe.Pointer(&in.ServerCert))
	out.ServerKey = *(*[]byte)(unsafe.Pointer(&in.ServerKey))
...
// Convert_config_CachedPodArgs_To_v1beta3_CachedPodArgs is an autogenerated conversion function.
func Convert_config_CachedPodArgs_To_v1beta3_CachedPodArgs(in *config.CachedPodArgs, out *CachedPodArgs, s conversion.Scope) error {
	return autoConvert_config_CachedPodArgs_To_v1beta3_CachedPodArgs(in, out, s)
}
...
func autoConvert_v1beta3_LimitAwareArgs_To_config_LimitAwareArgs(in *LimitAwareArgs, out *config.LimitAwareArgs, s conversion.Scope) error {
...
// Convert_v1beta3_LimitAwareArgs_To_config_LimitAwareArgs is an autogenerated conversion function.
func Convert_v1beta3_LimitAwareArgs_To_config_LimitAwareArgs(in *LimitAwareArgs, out *config.LimitAwareArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_LimitAwareArgs_To_config_LimitAwareArgs(in, out, s)
}

func autoConvert_config_LimitAwareArgs_To_v1beta3_LimitAwareArgs(in *config.LimitAwareArgs, out *LimitAwareArgs, s conversion.Scope) error {
	out.ScoringResourceWeights = *(*map[corev1.ResourceName]int64)(unsafe.Pointer(&in.ScoringResourceWeights))
	out.DefaultLimitToAllocatable = *(*extension.LimitToAllocatable)(unsafe.Pointer(&in.DefaultLimitToAllocatable))
	return nil
}

// Convert_config_LimitAwareArgs_To_v1beta3_LimitAwareArgs is an autogenerated conversion function.
func Convert_config_LimitAwareArgs_To_v1beta3_LimitAwareArgs(in *config.LimitAwareArgs, out *LimitAwareArgs, s conversion.Scope) error {
	return autoConvert_config_LimitAwareArgs_To_v1beta3_LimitAwareArgs(in, out, s)
}
...
func autoConvert_v1beta3_PriorityRangeConfig_To_config_PriorityRangeConfig(in *PriorityRangeConfig, out *config.PriorityRangeConfig, s conversion.Scope) error {
	out.PriorityStart = in.PriorityStart
	out.PriorityEnd = in.PriorityEnd
	out.EnablePreempt = in.EnablePreempt
	out.EnableBePreempted = in.EnableBePreempted
	out.EnableCrossBandPreempt = in.EnableCrossBandPreempt
	out.DefaultEvictAction = in.DefaultEvictAction
	out.PriorityLevel = in.PriorityLevel
	return nil
}

// Convert_v1beta3_PriorityRangeConfig_To_config_PriorityRangeConfig is an autogenerated conversion function.
func Convert_v1beta3_PriorityRangeConfig_To_config_PriorityRangeConfig(in *PriorityRangeConfig, out *config.PriorityRangeConfig, s conversion.Scope) error {
	return autoConvert_v1beta3_PriorityRangeConfig_To_config_PriorityRangeConfig(in, out, s)
}

func autoConvert_config_PriorityRangeConfig_To_v1beta3_PriorityRangeConfig(in *config.PriorityRangeConfig, out *PriorityRangeConfig, s conversion.Scope) error {
	out.PriorityStart = in.PriorityStart
	out.PriorityEnd = in.PriorityEnd
	out.EnablePreempt = in.EnablePreempt
	out.EnableBePreempted = in.EnableBePreempted
...
// Convert_config_PriorityRangeConfig_To_v1beta3_PriorityRangeConfig is an autogenerated conversion function.
func Convert_config_PriorityRangeConfig_To_v1beta3_PriorityRangeConfig(in *config.PriorityRangeConfig, out *PriorityRangeConfig, s conversion.Scope) error {
	return autoConvert_config_PriorityRangeConfig_To_v1beta3_PriorityRangeConfig(in, out, s)
}
...
func autoConvert_v1beta3_UnifiedPodConstraintArgs_To_config_UnifiedPodConstraintArgs(in *UnifiedPodConstraintArgs, out *config.UnifiedPodConstraintArgs, s conversion.Scope) error {
	out.EnableDefaultPodConstraint = (*bool)(unsafe.Pointer(in.EnableDefaultPodConstraint))
	return nil
}

// Convert_v1beta3_UnifiedPodConstraintArgs_To_config_UnifiedPodConstraintArgs is an autogenerated conversion function.
func Convert_v1beta3_UnifiedPodConstraintArgs_To_config_UnifiedPodConstraintArgs(in *UnifiedPodConstraintArgs, out *config.UnifiedPodConstraintArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_UnifiedPodConstraintArgs_To_config_UnifiedPodConstraintArgs(in, out, s)
}

func autoConvert_config_UnifiedPodConstraintArgs_To_v1beta3_UnifiedPodConstraintArgs(in *config.UnifiedPodConstraintArgs, out *UnifiedPodConstraintArgs, s conversion.Scope) error {
	out.EnableDefaultPodConstraint = (*bool)(unsafe.Pointer(in.EnableDefaultPodConstraint))
	return nil
}

// Convert_config_UnifiedPodConstraintArgs_To_v1beta3_UnifiedPodConstraintArgs is an autogenerated conversion function.
func Convert_config_UnifiedPodConstraintArgs_To_v1beta3_UnifiedPodConstraintArgs(in *config.UnifiedPodConstraintArgs, out *UnifiedPodConstraintArgs, s conversion.Scope) error {
	return autoConvert_config_UnifiedPodConstraintArgs_To_v1beta3_UnifiedPodConstraintArgs(in, out, s)
}
