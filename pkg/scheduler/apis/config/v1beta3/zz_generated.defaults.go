...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&ASIQuotaAdaptorArgs{}, func(obj interface{}) { SetObjectDefaults_ASIQuotaAdaptorArgs(obj.(*ASIQuotaAdaptorArgs)) })
...
func SetObjectDefaults_ASIQuotaAdaptorArgs(in *ASIQuotaAdaptorArgs) {
	SetDefaults_ASIQuotaAdaptorArgs(in)
}
