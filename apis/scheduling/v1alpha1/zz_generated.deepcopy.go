...
func (in *DrainNodeGroupSpec) DeepCopyInto(out *DrainNodeGroupSpec) {
	*out = *in
	...
	if in.DrainNodePolicy != nil {
		in, out := &in.DrainNodePolicy, &out.DrainNodePolicy
		*out = new(DrainNodePolicy)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DrainNodePolicy) DeepCopyInto(out *DrainNodePolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DrainNodePolicy.
func (in *DrainNodePolicy) DeepCopy() *DrainNodePolicy {
	if in == nil {
		return nil
	}
	out := new(DrainNodePolicy)
...
func (in *DrainNodeStatus) DeepCopyInto(out *DrainNodeStatus) {
	*out = *in
	if in.MigrationJobStatus != nil {
		in, out := &in.MigrationJobStatus, &out.MigrationJobStatus
		*out = make([]MigrationJobStatus, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
