...
require (
	...
	gitlab.alibaba-inc.com/cos/recommender v0.6.2
...
replace (
	...
	github.com/koordinator-sh/scheduler-plugins => gitlab.alibaba-inc.com/koordinator-sh/scheduler-plugins v0.0.0-20230818040335-0e5c51338e65
