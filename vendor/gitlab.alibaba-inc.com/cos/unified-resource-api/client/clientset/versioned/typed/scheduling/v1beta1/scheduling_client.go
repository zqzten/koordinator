...
type SchedulingV1beta1Interface interface {
	...
	DevicesGetter
	ReserveResourcesGetter
}

// SchedulingV1beta1Client is used to interact with features provided by the scheduling.alibabacloud.com group.
type SchedulingV1beta1Client struct {
	restClient rest.Interface
}

func (c *SchedulingV1beta1Client) Devices() DeviceInterface {
	return newDevices(c)
}

func (c *SchedulingV1beta1Client) ReserveResources(namespace string) ReserveResourceInterface {
	return newReserveResources(c, namespace)
}
