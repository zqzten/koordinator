...
import (
	...
	"gitlab.alibaba-inc.com/cos/unified-resource-api/client/clientset/versioned/scheme"
...
type AutoscalingV1alpha1Interface interface {
	...
	RecommendationCheckpointsGetter
	RecommendationProfilesGetter
}
...
func (c *AutoscalingV1alpha1Client) Recommendations(namespace string) RecommendationInterface {
	return newRecommendations(c, namespace)
}

func (c *AutoscalingV1alpha1Client) RecommendationCheckpoints(namespace string) RecommendationCheckpointInterface {
	return newRecommendationCheckpoints(c, namespace)
}

func (c *AutoscalingV1alpha1Client) RecommendationProfiles() RecommendationProfileInterface {
	return newRecommendationProfiles(c)
}
