	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1alpha1().Recommendations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutoscalingV1alpha1().Recommendations(namespace).Watch(context.TODO(), options)
			},
		},
		&autoscalingv1alpha1.Recommendation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recommendationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&autoscalingv1alpha1.Recommendation{}, f.defaultInformer)
}
