...
type NodeMetricInformer interface {
	...
	Lister() v1beta1.NodeMetricLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NodesV1beta1().NodeMetrics().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NodesV1beta1().NodeMetrics().Watch(context.TODO(), options)
			},
		},
		&nodesv1beta1.NodeMetric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeMetricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodesv1beta1.NodeMetric{}, f.defaultInformer)
}

func (f *nodeMetricInformer) Lister() v1beta1.NodeMetricLister {
	return v1beta1.NewNodeMetricLister(f.Informer().GetIndexer())
}
