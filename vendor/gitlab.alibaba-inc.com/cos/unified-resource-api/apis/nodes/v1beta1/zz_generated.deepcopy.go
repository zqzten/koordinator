...
import (
	"gitlab.alibaba-inc.com/cos/unified-resource-api/apis/resources/v1alpha1"
	"k8s.io/api/core/v1"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricCollectPolicy) DeepCopyInto(out *MetricCollectPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricCollectPolicy.
func (in *MetricCollectPolicy) DeepCopy() *MetricCollectPolicy {
	if in == nil {
		return nil
	}
	out := new(MetricCollectPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkQOS) DeepCopyInto(out *NetworkQOS) {
	*out = *in
	if in.BandwidthRequestPercent != nil {
		in, out := &in.BandwidthRequestPercent, &out.BandwidthRequestPercent
		*out = new(int64)
		**out = **in
	}
	if in.BandwidthLimitPercent != nil {
		in, out := &in.BandwidthLimitPercent, &out.BandwidthLimitPercent
		*out = new(int64)
		**out = **in
	}
	if in.PacketDSCP != nil {
		in, out := &in.PacketDSCP, &out.PacketDSCP
		*out = new(int64)
		**out = **in
	}
}
...
func (in *NodeMetricInfo) DeepCopyInto(out *NodeMetricInfo) {
	*out = *in
	in.NodeUsed.DeepCopyInto(&out.NodeUsed)
}
...
func (in *NodeSLOSpec) DeepCopyInto(out *NodeSLOSpec) {
	*out = *in
	...
	if in.Cgroups != nil {
		...
		*out = make([]*v1alpha1.NodeCgroupsInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1alpha1.NodeCgroupsInfo)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
func (in *PodMetricInfo) DeepCopyInto(out *PodMetricInfo) {
	*out = *in
	in.PodUsed.DeepCopyInto(&out.PodUsed)
}
...
func (in *QOSConfig) DeepCopyInto(out *QOSConfig) {
	*out = *in
	...
	if in.MemoryQOSEnable != nil {
		in, out := &in.MemoryQOSEnable, &out.MemoryQOSEnable
		*out = new(bool)
		**out = **in
	}
	if in.MemoryMinLimitPercent != nil {
		in, out := &in.MemoryMinLimitPercent, &out.MemoryMinLimitPercent
		*out = new(int64)
		**out = **in
	}
	if in.MemoryLowLimitPercent != nil {
		in, out := &in.MemoryLowLimitPercent, &out.MemoryLowLimitPercent
		*out = new(int64)
		**out = **in
	}
	if in.MemoryThrottlingPercent != nil {
		in, out := &in.MemoryThrottlingPercent, &out.MemoryThrottlingPercent
		*out = new(int64)
		**out = **in
	}
	if in.MemoryWmarkRatio != nil {
		in, out := &in.MemoryWmarkRatio, &out.MemoryWmarkRatio
		*out = new(int64)
		**out = **in
	}
	if in.MemoryWmarkScalePermill != nil {
		in, out := &in.MemoryWmarkScalePermill, &out.MemoryWmarkScalePermill
		*out = new(int64)
		**out = **in
	}
	if in.MemoryWmarkMinAdj != nil {
		in, out := &in.MemoryWmarkMinAdj, &out.MemoryWmarkMinAdj
		*out = new(int64)
		**out = **in
	}
	if in.MemoryPriorityEnable != nil {
		in, out := &in.MemoryPriorityEnable, &out.MemoryPriorityEnable
		*out = new(int64)
		**out = **in
	}
	...
	if in.MemoryOomKillGroup != nil {
		in, out := &in.MemoryOomKillGroup, &out.MemoryOomKillGroup
		*out = new(int64)
		**out = **in
	}
