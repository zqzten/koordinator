...
// NewAverageEstimator return a new avgEstimator.
func NewAverageEstimator() ResourceEstimator {
	return &avgEstimator{}
}
...
func (e *avgEstimator) GetResourceEstimation(s *model.AggregateContainerState) model.Resources {
	return model.Resources{
		model.ResourceCPU: model.CPUAmountFromCores(
			s.AggregateCPUUsage.Average()),
		model.ResourceMemory: model.MemoryAmountFromBytes(
			s.AggregateMemoryPeaks.Average()),
	}
}
