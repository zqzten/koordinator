...
// RemoveExpired Removes entries which we didn't read in a while from the cache.
...
//GetKeysToRefresh Returns a list of keys for which values need to be refreshed
