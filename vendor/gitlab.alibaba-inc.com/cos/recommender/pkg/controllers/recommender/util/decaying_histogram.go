...
func (h *decayingHistogram) SaveToCheckpoint() (*recv1alpha1.HistogramCheckpoint, error) {
...
func (h *decayingHistogram) LoadFromCheckpoint(checkpoint *recv1alpha1.HistogramCheckpoint) error {
